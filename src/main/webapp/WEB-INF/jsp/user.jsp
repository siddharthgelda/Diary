								...
								<div id="mainPageinlineContent" class="s8inlineContent"
								   ...
								   <form id="info" method="post" >
									  <ul class="ul-no-bult">
										 ...
										 <li>
											<label class="formlable s2repeaterButton"> Age</label>
										 ...
										 <li>
											<label class="formlable s2repeaterButton">Gender</label>
											<select name="Gender" id="Gender">
											   <option value="male">Male</option>
											   <option value="female">Female</option>
											</select>
										 <li ><input type="submit" class="btnsubmit" value="submit" id="sbt" name="sbt"/></li>
									  </ul>
								   </form>
								</div>
							 </div>
