...
margin: 8px !important;
			...
			<div class="SITE_ROOT" id="SITE_ROOT"
				...
				<div id="SITE_STRUCTURE"
					...
					<div
						style="width: 980px; position: absolute; top: 0px; height: 96px; left: 0px;"
...
<form id="info" method="post" >
  <ul>
    ...
    <li><label class="formlable s2repeaterButton" > Last name</label> <input type="text" name="LastName" id="LastName"/></li>
    <li><label class="formlable s2repeaterButton"> E-mail address</label> <input type="text" name="email" id="email" /></li>
    <li><label class="formlable s2repeaterButton"> MobileNo</label> <input type="text" name="MobileNo" id="MobileNo"/></li>
    <li><label class="formlable s2repeaterButton"> Landline Number</label> <input type="text" name="LandlineNumber" id="LandlineNumber"/></li>
    <li><label class="formlable s2repeaterButton"> Address</label> <input type="textarea" rows="4" cols="50" name="Address" id="Address"/></li>
    
    <li><label class="formlable s2repeaterButton"> Age</label> <select id="Age" name="Age">
    <%for(int age=1; age<=100;age++) {%>
    <option value=<% out.print(age); %>><% out.print(age); %></option>
    <%} %>
    </select>
    </li>
    <li><label class="formlable s2repeaterButton">Gender</label> <select name="Gender" id="Gender"><option value="male">Male</option><option value="female">Female</option></select>
     <li ><label style="visibility: hidden;" class="formlable">Gender</label><input type="submit" class="btnsubmit" value="submit" id="sbt" name="sbt"/></li>
  </ul>
</form>
</div>
</div>
