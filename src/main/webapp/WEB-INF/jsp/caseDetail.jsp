            ...
            content: "@#$%%^&*~IAO"
					...
					<div class="SITE_ROOT" id="SITE_ROOT"
					   ...
					   <div id="SITE_STRUCTURE"
                         ...
                         List<UserDetail> caselist=(List<UserDetail>)request.getAttribute("case");
                                            UserDetail casedetail=caselist.get(0);

%>
            <div
               style="left: 0px; width: 100%; position: absolute; top: 20px; height: 100%;margin-top:110px"
                                ...
                                :
                                    <%
                                       ...
                                       while(it.hasNext()){
                                        Object o=it.next();
                                        Court c=(Court)o;
                                        if(casedetail.getCourt().getId()==c.getId())
                                 ...
                                 <li><label class="formlable s2repeaterButton"> Company</label>
                                   :
                                    <%Iterator Companyiterator=companys.iterator();
                                       ...
                                       Company c=(Company)o;
                                         if(casedetail.getCompany().getId()==c.getId())
                                      {
                                      out.println(c.getName());
                                      }
                                      }
                                 ...
                                 <label class="formlable s2repeaterButton">City</label>
                                   :
                                    <%
                                       ...
                                       City c=(City)o;
                                      if(casedetail.getCity().getId()==c.getId())
                                       {
                                        out.println(c.getName());
                                         }
                                       }%>
