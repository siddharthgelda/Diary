...
<html class="">
   <head>
      ...
      <%
        Boolean emailStatus=(Boolean)request.getAttribute("emailStatus");
    if(emailStatus!=null)
    {
    %>
    <script>
                  ...
                  <div
                     ...
                     <div
                        ...
                        <div id="mainPageinlineContent" class="s8inlineContent"
                           style="position: absolute; top: 156px; width: 100%; left: 70px; height: 80%;margin-left:150px"
                              ...
                              <tbody>
                                 ...
                                 <tr style="width: 0% ! important;">
                                    <td style="height: 100% ! important;width:50%"><a
                                       ...
                                       id="mainPage_SiteButton_4link" class="s11link"> <span
                                       style="height: 100%; width: 100%; margin-top: 4%;margin-bottom:4%"
                                       id="mainPage_SiteButton_4label" class="s11label">Case List &nbsp &nbsp </span></a></td>
                                    <td style="height: 100%;width:50%"><a
                                       href="/caselist"
                                       style="text-align: center; width: 90%; height: 100%; display: block"
                                       id="mainPage_SiteButton_4link" class="s11link"> <span
                                       style="height: 100%; margin-top: 4%;margin-bottom:4%; width: 100%"
                                 ...
                                 <tr>
                                    <td style="height: 100% ! important;width:50%"><a
                                       ...
                                       id="mainPage_SiteButton_4link" class="s11link"> <span
                                       style="height: 100%; width: 100%; margin-top: 4%;margin-bottom:4%"
                                       id="mainPage_SiteButton_4label" class="s11label">Bills</span></a></td>
                                    <td style="height: 100%;width:50%"><a
                                       href="/caseEmail"
                                       style="text-align: center; width: 90%; height: 100%; display: block"
                                       id="mainPage_SiteButton_4link" class="s11link"> <span
                                       style="height: 100%; margin-top: 4%;margin-bottom:4%s width: 70%"
                                       id="mainPage_SiteButton_4label" class="s11label">Send Todays Cases EMail</span></a></td>
                                 </tr>
                              </tbody>
                           </table>
                        </div>
