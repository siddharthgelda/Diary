...
<html class="">
   <head>
      ...
      $PAGES_CONTAINER.1.1.$SITE_PAGES
   </head>
   <body style="" class="">
         ...
         <div class="noop" data-reactid=".0">
            <div data-reactid=".0.0">
               ...
               <div
                  ...
                  <div
                     style="left: 0px; width: 980px; position: absolute; top: 56px; height: 1142px;"
                     ...
                     <%
                        ...
                        %>
                     <table border="1"  width="100%" style="width: 100%;margin-top: 100px;text-align: center;">
                        <tr>
                           <th>FileNo</th>
                           <th>CaseNo</th>
                           <th style="display:block; width:220px;height:40px">Case Title</th>
                           <th>Advocate</th>
                           <th style="display:block; width:150px;height:40px">Stage</th>
                           <th>Description</th>
                           <th>Previous Date</th>
                           <th>Next Date</th>
                           <th>Court</th>
                        ...
                        <tr>
                        <tr>
                           <td><%=caseobj.getFileNo() %></td>
                           <td><%=caseobj.getCaseNo() %></td>
                           <td><%=caseobj.getAgainstClient() %></td>
                           <td><%=caseobj.getAdvocate() %></td>
                           <td><%=caseobj.getStage() %></td>
                           <td><%=caseobj.getDescripation() %></td>
                           <%
                           ...
                           <%
                              ...
                              %>
                           <td><%=nextdate%></td>
                           <td><%=caseobj.getCourt().getName() %></td>
